          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2 print:hidden">
              <button
                ...
                className="flex items-center space-x-1.5 bg-cyan-600 hover:bg-cyan-500 text-white font-black text-xs px-3.5 py-2.5 min-h-[44px] rounded-xl shadow-sm transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center space-x-1 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs px-3.5 py-2.5 min-h-[44px] rounded-xl transition-all cursor-pointer"
              >
